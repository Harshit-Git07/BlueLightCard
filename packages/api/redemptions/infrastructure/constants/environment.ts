export enum RedemptionsStackEnvironmentKeys {
  ...
  REDEMPTIONS_LAMBDA_SCRIPTS_BALLOT_PATH = 'REDEMPTIONS_LAMBDA_SCRIPTS_BALLOT_PATH',
  ...
  BRAZE_VERIFY_EMAIL_CAMPAIGN_ID = 'BRAZE_VERIFY_EMAIL_CAMPAIGN_ID',
  BRAZE_BALLOT_EMAIL_CAMPAIGN_ID = 'BRAZE_BALLOT_EMAIL_CAMPAIGN_ID',
  ...
  BRAZE_REDEMPTION_VERIFY_PUSH_NOTIFICATION_CAMPAIGN_ID = 'BRAZE_REDEMPTION_VERIFY_PUSH_NOTIFICATION_CAMPAIGN_ID',
  BRAZE_REDEMPTION_BALLOT_PUSH_NOTIFICATION_CAMPAIGN_ID = 'BRAZE_REDEMPTION_BALLOT_PUSH_NOTIFICATION_CAMPAIGN_ID',
  ...
  // DWH Firehose v2
  DWH_FIREHOSE_MEMBER_REDEMPTIONS_STREAM_NAME = 'DWH_FIREHOSE_MEMBER_REDEMPTIONS_STREAM_NAME',
  DWH_FIREHOSE_VAULT_INTEGRATION_STREAM_NAME = 'DWH_FIREHOSE_VAULT_INTEGRATION_STREAM_NAME',
  DWH_FIREHOSE_VAULT_STOCK_STREAM_NAME = 'DWH_FIREHOSE_VAULT_STOCK_STREAM_NAME',
  DWH_FIREHOSE_VAULT_BATCH_STOCK_STREAM_NAME = 'DWH_FIREHOSE_VAULT_BATCH_STOCK_STREAM_NAME',
