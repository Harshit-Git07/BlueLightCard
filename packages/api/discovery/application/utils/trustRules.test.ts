...
describe('trustRules', () => {
  ...
  it('should return false if the users service is in the excluded trusts and included trusts is empty', () => {
    const result = isValidTrust('NHS', [], ['NHS']);

    expect(result).toBe(false);
  });
  it('should return false when users service is in the included trusts & excluded trusts', () => {
    const result = isValidTrust('NHS', ['NHS'], ['NHS']);
  ...
  it('should return true when users service is not in the excluded trusts and included trusts is empty', () => {
