...
jest.mock('jwt-decode', () => () => ({  client_id: 1234,  'custom:blc_old_uuid': 'testUUID'}))
  ...
  describe('User Profile, Brand and Card data', () => {
    ...
    test('DynamoDB is called and response is valid with 200 status when request is valid', async () => {
      ...
      expect(res).toEqual({
        statusCode: 200,
        body: "{\"message\":\"User Found\",\"data\":{\"profile\":{\"firstname\":\"rubi\",\"surname\":\"limbu\",\"organisation\":\"AMBU\",\"dob\":\"1987-12-27\",\"gender\":\"F\",\"mobile\":\"+447915507274\",\"email\":\"rlimbu+work1@bluelightcard.co.uk\",\"email_validated\":1,\"spare_email\":\"rlimbu+work1@bluelightcard.co.uk\",\"spare_email_validated\":1,\"twoFactorAuthentication\":false,\"spareEmail\":\"rlimbu+work1@bluelightcard.co.uk\",\"spareEmailValidated\":1,\"emailValidated\":1},\"cards\":[{\"cardId\":\"3470584\",\"expires\":\"1758365897\",\"cardStatus\":\"PHYSICAL_CARD\",\"datePosted\":\"1695220641\"}],\"companies_follows\":[{\"companyId\":\"123\",\"likeType\":\"Like\"}],\"legacyId\":2853201,\"uuid\":\"068385bb-b370-4153-9474-51dd0bfac9dc\",\"brand\":\"BLC_UK\"}}",
        headers: {
    ...
    test('provided data with null for nullable fields, zod processes it correctly and 200 is returned with correct response body', async () => {
      ...
      expect(res).toEqual({
        statusCode: 200,
        body: "{\"message\":\"User Found\",\"data\":{\"profile\":{\"firstname\":\"rubi\",\"surname\":\"limbu\",\"organisation\":\"AMBU\",\"dob\":null,\"gender\":null,\"mobile\":null,\"email\":\"rlimbu+work1@bluelightcard.co.uk\",\"email_validated\":1,\"spare_email\":\"rlimbu+work1@bluelightcard.co.uk\",\"spare_email_validated\":1,\"twoFactorAuthentication\":false,\"spareEmail\":\"rlimbu+work1@bluelightcard.co.uk\",\"spareEmailValidated\":1,\"emailValidated\":1},\"cards\":[{\"cardId\":\"3470584\",\"expires\":\"1758365897\",\"cardStatus\":\"PHYSICAL_CARD\",\"datePosted\":null}],\"companies_follows\":[{\"companyId\":\"123\",\"likeType\":\"Like\"}],\"legacyId\":2853201,\"uuid\":\"068385bb-b370-4153-9474-51dd0bfac9dc\",\"brand\":\"BLC_UK\"}}",
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin': '*'
        },
