...
import * as TenancyBannerPresenter from './TenancyBanner.stories';

<Meta of={TenancyBannerPresenter} />
...
<Canvas of={TenancyBannerPresenter.Large} />

### Small

<Canvas of={TenancyBannerPresenter.Small} />
