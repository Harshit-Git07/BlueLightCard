...
export class GetOrganisationsRoute {
  constructor(
    private apiGatewayModelGenerator: ApiGatewayModelGenerator,
    private agOrganisationModel: Model,
  ...
  getRouteDetails(): ApiGatewayV1ApiRouteProps<never> {
    return {
      function: {
        handler: 'packages/api/members/application/handlers/organisations/getOrganisations.handler',
        environment: {
          SERVICE: 'member',
        ...
        permissions: [
          new PolicyStatement({
            ...
            resources: [
              `arn:aws:dynamodb:*:*:table/${this.identityTableName}`,
              `arn:aws:dynamodb:*:*:table/${this.identityTableName}/index/gsi1`,
            ],
          }),
        ],
      },
      ...
      cdk: {
        method: {
          requestModels: { 'application/json': this.agOrganisationModel.getModel() },
          methodResponses: MethodResponses.toMethodResponses([
            new ResponseModel('200', this.agOrganisationModel),
