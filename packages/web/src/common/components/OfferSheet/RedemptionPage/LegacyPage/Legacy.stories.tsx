...
const meta: Meta = {
  title: 'Component System/Offer Sheet/Redemption Page/Legacy',
...
export const Success = () => {
  return <LegacyPage {...props} state="success" />;
};

export const Loading = () => {
  return <LegacyPage {...props} state="loading" />;
};

export const Error = () => {
  return <LegacyPage {...props} state="error" />;
};
