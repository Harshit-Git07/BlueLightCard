...
import InputSelectFieldWithRef from './InputSelectField';
...
const componentMeta: Meta<typeof InputSelectFieldWithRef> = {
  title: 'Component System/identity/InputSelectField',
  component: InputSelectFieldWithRef,
  argTypes: {
    icon: {
...
const InputSelectFieldTemplate: StoryFn<typeof InputSelectFieldWithRef> = (args) => (
  <InputSelectFieldWithRef {...args} />
);
