...
import { managementApiClient } from '@blc-mono/members/application/services/auth0/auth0Clients';
import { Auth0ClientService } from '@blc-mono/members/application/services/auth0/auth0ClientService';

jest.mock('@blc-mono/members/application/services/auth0/auth0Clients');
