...
const Example = () => {
  ...
  const onClick = () => openDrawer(<ChangePasswordForm memberId={memberId} onPasswordUpdateSuccessful={() => {}} />);
...
const PageExample = () => {
  ...
  const onClick = () => openDrawer(<ChangePasswordForm memberId={memberId} onPasswordUpdateSuccessful={onPasswordUpdateSuccess} />);
