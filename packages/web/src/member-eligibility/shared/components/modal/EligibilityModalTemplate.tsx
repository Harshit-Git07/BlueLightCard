...
export const EligibilityModalTemplate: FC<Props> = ({ classname, image, children, ...props }) => {
  ...
  return (
    <article
      className="z-50 fixed inset-0 bg-black bg-opacity-[78%] backdrop-blur-sm flex flex-col justify-center items-center"
