    ...
    case 'radial':
      return (
        <>
          <div className="flex">
            <div className="">
              <input type="checkbox" checked={checked} className="sr-only" onChange={handleChange} />
              <div
              ...
              >
                <span className={`h-[10px] w-[10px] rounded-full ${checked ? 'bg-black' : 'bg-transparent'}`}> </span>
              </div>
            </div>
            <div>
