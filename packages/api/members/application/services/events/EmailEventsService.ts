...
let emailEventsServiceSingleton: EmailEventsService;
...
export function emailEventsService(): EmailEventsService {
  if (!emailEventsServiceSingleton) {
    emailEventsServiceSingleton = new EmailEventsService();
  }

  return emailEventsServiceSingleton;
}
