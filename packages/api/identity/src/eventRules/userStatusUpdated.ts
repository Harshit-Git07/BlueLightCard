...
export const userStatusUpdatedRule = (userPoolId: string, dlqUrl: string, ddsUserPoolId: string, region: string, unsuccessfulLoginAttemptsTableName: string, oldUserPoolId: string, oldDdsUserPoolId: string, role: Role) => ({
