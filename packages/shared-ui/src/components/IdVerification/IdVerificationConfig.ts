import { IdVerificationDetail, IdVerificationMethod } from './IdVerificationTypes';
import { faCircleBolt } from '@fortawesome/pro-solid-svg-icons';

export const idVerificationText = {
  intro: {
    default: 'Verify your employment status with a valid ID or email to start saving.',
    withSupporting:
      'Verify your employment status with your work contract and one supporting document.',
  },
