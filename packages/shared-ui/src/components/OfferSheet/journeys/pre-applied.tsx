...
const buttonTypeMap = {
  ...
  pressed: {
    label: 'Discount automatically applied',
    description: 'Redirecting to partner website',
...
export default function PreAppliedRedemptionJourney(props: Readonly<VaultCodeJourneyProps>) {
