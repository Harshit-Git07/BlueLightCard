...
import * as footerConfigHelper from '../../Footer/v2/helpers/getFooterDetails';
import '@testing-library/jest-dom';
import { FooterConfig } from '../../Footer/v2/types';

jest.mock('../../Footer/v2/helpers/getFooterDetails', () => ({
